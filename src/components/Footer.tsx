export function Footer() {
  return (
    <footer>
      <div className="site-container flex min-h-16 flex-col items-center justify-between gap-4 py-4 sm:flex-row">
        <p className="text-sm text-muted">
          Built with ❤️ in London • © {new Date().getFullYear()}
        </p>
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <svg aria-hidden="true" viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="currentColor">
              <path d="M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.41l-5.8-7.58-6.63 7.58H.47l8.6-9.83L0 1.15h7.59l5.24 6.93L18.9 1.15Zm-1.29 19.49h2.04L6.49 3.24H4.3l13.31 17.4Z" />
            </svg>
          </a>
        </div>
      </div>
